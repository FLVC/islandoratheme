...
<div class="islandora-basic-image-object islandora">
  ...
  <div class="islandora-basic-image-sidebar">
    <dl>
      <?php if(isset($dc_array['dc:date']['value'])): ?>
        <dt><?php print $dc_array['dc:date']['label']; ?>:</dt>
        <dd><?php print $dc_array['dc:date']['value']; ?></dd>
      <?php endif; ?>
      <?php if(isset($dc_array['dc:description']['value'])): ?>
        <dt><?php print $dc_array['dc:description']['label']; ?>:</dt>
        <dd><?php print $dc_array['dc:description']['value']; ?></dd>
      <?php endif; ?>
    </dl>
  </div>
