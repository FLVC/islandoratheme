...
/**
 * Override the Islandora Remote Resource Object preprocess function
 */
function islandoratheme_preprocess_islandora_solution_pack_remote_resource(&$variables) {
  ...
  // Create the download link
  $variables['islandora_download_link'] = $islandora_object['OBJ']->content;
...
function islandoratheme_preprocess_islandora_scholar_citation(&$variables) {
  ...
  $variables['ip_embargoed'] = $embargo_data['ip_embargoed'];
  ...
  $variables['pdfless_icon'] = $base_url . "/sites/all/themes/islandoratheme/images/no-full-text.png";
}
...
function get_embargo_status($islandora_object) {
  if (!islandora_datastream_load('RELS-INT', $islandora_object)) {
    $embargo_data['cron_embargoed'] = FALSE;
